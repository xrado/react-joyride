...
var Tooltip = React.createClass({
  ...
  _getArrowPosition: function _getArrowPosition(position) {
    var arrowPosition;
  ...
  _generateArrow: function _generateArrow(opts) {
  ...
  _setStyles: function _setStyles(opts, styles, stepStyles) {
    styles.hole = {
  ...
  render: function render() {
    ...
    if (step.title) {
      opts.header = React.createElement('div', {
